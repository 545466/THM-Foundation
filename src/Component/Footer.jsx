    ...
    <>
      <section className=' bg-DarkGreen text-White'>
          ...
          <div className='flex lg:flex-col lg:w-1/4'>
            ...
            <h1 className='font-bold pl-5 lg:pl-0 lg:mt-5 text-Yellow'>TERRESTRIAL HUMANITARIAN EMPOWERMENT FOUNDATION</h1>
          </div>
          <div className='flex flex-col lg:py-0 py-10'>
            <h1 className='font-bold text-xl text-Yellow'>Our Company</h1>
          ...
          <div>
            <h1 className=' font-bold text-xl text-Yellow'>Social Media</h1>
