    ...
    <>
      <section className="px-10 py-20 ">
        ...
        transition = {{duration: 0.6}}>
          <h1 className="text-Yellow font-bold lg:px-20 text-xl pb-5">
        ...
        <h1 className="font-bold text-2xl text-Yellow text-center mt-20">WHAT WE DO</h1>
          ...
          Data.map((Datas)=>{
            return(
              <div key={Datas.id} className="mt-20 lg:mt-10 lg:mx-10 bg-DarkGreen text-White rounded-2xl lg:w-1/4" >
                ...
                <button className="ml-5 my-5 font-semibold bg-Yellow text-White px-5 rounded py-2"  onClick={(()=>setOpen(!open))}>{open ? "Show More": "Show Less"}</button>     
              </div>
            )
          })
        }
